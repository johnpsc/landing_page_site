        ...
        <section id="contato" className="py-24 px-6" style={{ backgroundColor: Cores.secundaria }}>
            <div className="container mx-auto max-w-2xl text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center mb-10">
                    <a href={ConfigSite.contact.whatsappUrl} target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 px-5 py-3 rounded-xl text-white font-bold text-sm hover:-translate-y-0.5 transition-all" style={{ backgroundColor: Cores.primaria }}>
                        💬 {textos.contato.rotuloWhatsapp}
                    </a>
                    <a href={`mailto:${ConfigSite.contact.email}`} className="inline-flex items-center gap-2 px-5 py-3 rounded-xl font-bold text-sm bg-white border border-gray-200 hover:bg-gray-50 transition-colors" style={{ color: Cores.escura }}>
                        ✉️ {ConfigSite.contact.email}
                    </a>
                </div>
            ...
            <div className="container mx-auto max-w-5xl">
                ...
                <div className="grid md:grid-cols-3 gap-6 mb-10">
                    ...
                    <div className="flex flex-col items-center text-center p-8 rounded-2xl border border-gray-100">
                        ...
                        <p className="text-sm" style={{ color: Cores.textoSuave }}>Seg–Sex {ConfigSite.support.hours.weekdays}</p>
                    </div>
                </div>
