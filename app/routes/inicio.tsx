  ...
  return (
    <section className="pt-40 pb-28 w-full px-4 md:px-8 flex flex-col items-center text-center relative overflow-hidden">
      ...
      <h1 className="text-5xl md:text-7xl font-extrabold mb-8 leading-tight max-w-5xl tracking-tight" style={{ color: Cores.escura }}>
        {Textos.heroi.tituloAntes} <span className="text-transparent bg-clip-text" style={{ backgroundImage: `linear-gradient(to right, ${Cores.primaria}, ${Cores.primariaEscura})` }}>{Textos.heroi.tituloDestaque}</span>
      </h1>
        ...
        <div className="grid md:grid-cols-2 gap-16 items-start">
          ...
          <div>
            ...
            <div className="flex flex-col gap-5">
              <a
                href={ConfigSite.contact.whatsappUrl}
                target="_blank"
                rel="noreferrer"
              ...
              <a
                href={`mailto:${ConfigSite.contact.email}`}
                className="flex items-center gap-4 p-5 bg-white rounded-2xl border border-gray-100 hover:border-(--color-primary-light) hover:shadow-(--shadow-feature-card) transition-all duration-300 group"
              >
                <div className="w-12 h-12 rounded-xl flex items-center justify-center text-xl shrink-0 group-hover:scale-110 transition-transform" style={{ backgroundColor: Cores.primariaClara }}>
                  ✉️
                ...
                <div>
                  ...
                  <p className="text-sm" style={{ color: Cores.textoSuave }}>{ConfigSite.contact.email}</p>
                </div>
                <svg className="ml-auto w-4 h-4 shrink-0 opacity-30 group-hover:opacity-70 transition-opacity" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" />
                </svg>
...
function ModernFeatureCard({ icon, title, desc }: { icon: string; title: string; desc: string }) {
  return (
    <div className="bg-white p-8 rounded-3xl border border-gray-100 hover:border-(--color-primary-light) shadow-sm hover:shadow-(--shadow-feature-card) transition-all duration-300 group">
      <div className="w-14 h-14 text-2xl flex items-center justify-center rounded-2xl mb-6 group-hover:scale-110 group-hover:bg-(--color-primary) group-hover:text-white transition-all duration-300" style={{ backgroundColor: Cores.primariaClara }}>
        {icon}
      </div>
